...
while resp.lower() == 's' :
    ...
    entrada_min = int(input('Minutos de entrada: '))
    ...
    if entrada_tot_min < 541:  # p1 Entro a la prueba
        ...
        print('1) Si puede ingresar a la prueba')  # p1
...
if cont_45 != 0:  # p6
    ...
    print('6) Promedio de notas en alumnos que llegaron después de transcurridos los 45 min es de: %.2f' % prom)